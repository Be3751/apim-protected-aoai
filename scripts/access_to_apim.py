...
if not apim_subscription_key:
    raise Exception("A subscription key should be provided to invoke the endpoint")
if not base_url:
...
url = f'{base_url}/deployments/{deployment_id}/chat/completions?api-version={api_version}'
headers = {
